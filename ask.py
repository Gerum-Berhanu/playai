...
async def run(prompt):
    async with async_playwright() as playwright:
        ...
        textarea =  await page.wait_for_selector("xpath=//*[@id='prompt-textarea']")
        button = await page.wait_for_selector("xpath=//*[@id='__next']/div[1]/div[2]/main/div[2]/div[2]/div[1]/div/form/div/div[2]/div/button")
